...
export const register: RegisterFun = (mod, appApi) => {
  ...
  mod.on_temperature_report = new Sk.builtin.func(
    function on_temperature_report(pyFun: SkObject) {
      return Sk.misceval.promiseToSuspension(registerHandler(pyFun));
    }
  );
};
